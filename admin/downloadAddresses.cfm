...
<cfoutput query="getLetters">
	...
	<cfif isDefined("URL.parent") and URL.parent eq "true">Parent(s) of </cfif>#out_result_set.first_name#</td><td>#out_result_set.mi#</td><td>#out_result_set.last_name#</td>
	...
	<cftry>
		...
		#address#</td>
	<td>#out_result_set.CITY#</td><td>#out_result_set.STATE#</td><td>#out_result_set.ZIP#
	<cfcatch>
		#cfcatch.message# #cfcatch.detail#
	</cfcatch>
	</cftry>
