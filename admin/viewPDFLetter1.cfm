...
#letter p {margin-bottom: 9px; margin-top:0px; font-size: 11pt; line-height:15px; }
...
<cfelse>
    <cfset decompressed_letter=Replace('#decompressed_letter#', 'file:///d:\inetpub\applicantstatus\admin\images\dean_berman_sig.jpg', 'file:///c:\inetpub\wwwroot\applicantstatus\admin\images\dean_berman_sig.jpg', 'ALL')>
</cfif>
