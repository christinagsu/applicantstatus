...
<cfif not isDefined("Cookie.UserAuth") or not isDefined("Cookie.campusid") or not isDefined("Session.referrer") or Session.referrer neq "add_letters"><cflocation addtoken="no" url="login_addletters.cfm"><cfabort></cfif>

<cfif Cookie.campusid eq ""><cflocation addToken="no" url="login_addletters.cfm" /><cfabort></cfif>
<cfif Cookie.campusid neq "jstulce" and Cookie.campusid neq "christina"><p>Sorry, you do not have access to this system. Thank you.</p><cfabort></cfif>
...
<script language="javascript" src="add_letter.js"></script>



<h1>Add Letters</h1>

<div width="100%" align="right" style="margin-right:20px;"><a href="login_addletters.cfm?logout=true">Log Out</a></div><Br><br>

<cfif isDefined("Form.admit_type")>
    <cfinvoke component="add_letters" method="validate_letter_form" />
<cfelse>
    <cfinvoke component="add_letters" method="add_letter_form" />
</cfif>

<cfif (not isDefined("Form.semester") or Form.semester eq "") and (not isDefined("Form.all_semesters") or Form.all_semesters neq "")><script>document.getElementById("semester_div").style.display="none";</script></cfif>
