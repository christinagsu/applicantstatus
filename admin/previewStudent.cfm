...
<cfif not isDefined("Session.admin_appstatus_user") or Session.admin_appstatus_user eq "" or not isDefined("cookie.UserAuth") or cookie.UserAuth eq false or isDefined("URL.logout")>
	...
	<cfif cgi.server_name eq "webdb.gsu.edu"><cfcache action="flush" timespan="0" directory="d:/Inetpub/wwwroot/applicantstatus/"></cfif>
...
#letter {margin-top:145px;margin-bottom:0px;}
        ...
        <cfelse>
        	<cfif isDefined("URL.template_type")>
            	<cfset curtemplatetype=URL.template_type>
            <cfelse>
