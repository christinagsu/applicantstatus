...
<script>
   function SetParentInfo() {
      window.opener.document.getElementById("stud_gpc_id").value=document.getElementById("studentId").value;
...
<cfif isDefined("submit_gpcid_request")>
   ...
   <cfhttp url="https://webapp-qa.gpc.edu/gsuApiCode/getGpcid" method="POST" result="result" charset="utf-8" port="443" >
  <cfhttpparam name="Content-Type" value="application/x-www-form-urlencoded" type="header">
    ...
    <cfhttpparam type="body" value='{"authentication":{"api_key":"GSU783354110","api_pass":"A|7E>arpK.L8:qkAX$ab"},"getGpcid":{"firstName3": "#Form.fname#",
        "lastName": "#Form.lname#",
        "ssnLast4": "#ssn#",
        "countryCode": "#country1#",
        "dob": "#Form.year#-#tmonth#-#Form.mday#"
}}'>
	</cfhttp>
...
<cfoutput>
   ...
   <h2>#getResult.studentId#</h2>
   <input type="hidden" id="studentId" value="#getResult.studentId#">
   ...
   <input type="hidden" id="lname" value="#Form.lname#">
   ...
   <form name="insergpcid">
     ...
     <input class="formbutton" type="submit" value="Copy my GPC-ID and Details to the Form" onclick='SetParentInfo(); self.close(); return false;' />
...
<title>Get Your GPC-ID Here! :: Georgia Perimeter College</title>
...
<form method="POST" action="getmygpcid.cfm" name="request_form" autocomplete="off" onsubmit="return validate();">
...
<input class="formbutton" type="submit" value="Get My GPC-ID" name="submit_gpcid_request">
 &nbsp; 
