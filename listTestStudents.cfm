...
<tr><th>First Name</th><th>Last Name</th><th>Panther ID</th><th>Birth Date</th></tr>
<cfoutput query="out_result_set_students">
	<tr><td>#first_name#</td><td>#last_name#</td><td>#student_id#</td><td>#DateFormat(birth_date, "mm/dd/yyyy")#</td></tr>
</cfoutput>
</table>--->
