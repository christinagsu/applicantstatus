...
<cfif isDefined("Session.student_id")>
	...
	<cfquery name="insertLogin" datasource="eAcceptance">
	    insert into student_clicks (click_id, panther_id, click_event, click_date, user_agent) values (studentclicks_seq.NEXTVAL, '#panther_no#', 3, #NOW()#, '#Left(CGI.HTTP_USER_AGENT, 499)#')
	</cfquery>
</cfif>
</body>
</html>
